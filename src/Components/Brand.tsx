...
const Brand = () => {
  ...
  return (
    <div className="w-full h-auto mb-20 px-4">
      <h1 className="font-clash-display text-darkPrimary mt-24 text-center text-[24px] font-bold sm:text-[28px]">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mt-12">
        {rows.map((row, index) => (
          <div
            key={index}
            className="flex flex-col items-start text-left p-6 bg-gray-500 border border-gray-200 rounded-lg shadow-sm hover:shadow-lg transition-all duration-300"
          >
